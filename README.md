...
- [Dependency Injection](docs/standards/dependency-injection.md) — Tier 3, code review; partial slice: `new` inside constructor bodies ([#176](https://github.com/mike-bronner/phpcs-rules/issues/176))
