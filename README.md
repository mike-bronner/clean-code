...
- [Conditionals: Mapping Arrays](docs/standards/conditionals-mapping-arrays.md) — Tier 3, code review; partial-enforcement sniff: same-variable if/elseif chains ([#163](https://github.com/mike-bronner/phpcs-rules/issues/163))
