...
- [Testing: Development Process (TDD)](docs/standards/testing-development-process-tdd.md) — Tier 3, not statically enforceable: test-first order and the Red/Green/Refactor cycle are facts about the process, not the tokens, so the standard stays with code review; two token-visible slices are queued as focused follow-ups ([#128](https://github.com/mike-bronner/phpcs-rules/issues/128), [#129](https://github.com/mike-bronner/phpcs-rules/issues/129)) ([#57](https://github.com/mike-bronner/phpcs-rules/issues/57))
