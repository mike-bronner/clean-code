...
- [Operators: Manipulative](docs/standards/operators-manipulative.md) — Tier 2, custom sniff `CleanCode.Operators.ManipulationOperatorPlacement`: manipulation operators (`. + - * / % ** && || & | ^ << >>`) must lead a wrapped line, not trail it; inline usage untouched, auto-fixable ([#59](https://github.com/mike-bronner/phpcs-rules/issues/59))
