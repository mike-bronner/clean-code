...
- [Conditionals: Ternary Conditionals](docs/standards/conditionals-ternary-conditionals.md) — Tier 1, Slevomat RequireTernaryOperator + custom nested-ternary sniff ([#20](https://github.com/mike-bronner/phpcs-rules/issues/20))
