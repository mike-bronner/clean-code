...
- [Properties: Are Required](docs/standards/properties-are-required.md) — Tier 2, custom sniff `CleanCode.Classes.RequireProperties`: flags any class declaring no instance or static property (promotion counts), detection-only ([#55](https://github.com/mike-bronner/phpcs-rules/issues/55))
