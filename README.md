...
- [Operators: Active](docs/standards/operators-active.md) — Tier 1, custom sniff extending `Squiz.WhiteSpace.OperatorSpacing`: exactly one space around assignment, logical, and string operators, auto-fixable ([#62](https://github.com/mike-bronner/phpcs-rules/issues/62))
