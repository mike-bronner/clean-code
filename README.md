...
- [Conditionals: No else or elseif](docs/standards/conditionals-no-else-or-elseif.md) — Tier 1, custom sniff: `CleanCode.Conditionals.DisallowElse`, auto-fixable where behavior-preserving ([#14](https://github.com/mike-bronner/phpcs-rules/issues/14))
