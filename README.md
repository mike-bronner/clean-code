...
- [Conditionals: Combine Where Possible](docs/standards/conditionals-combine-where-possible.md) — Tier 3, code review; partial slice tracked as sniff issue [#181](https://github.com/mike-bronner/phpcs-rules/issues/181)
