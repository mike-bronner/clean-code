...
- [Methods: No Null Arguments](docs/standards/methods-no-null-arguments.md) — Tier 2, custom sniff `CleanCode.Methods.NoNullArguments`: flags a literal `null` passed positionally into an optional parameter, auto-fixed to a named argument ([#71](https://github.com/mike-bronner/phpcs-rules/issues/71))
