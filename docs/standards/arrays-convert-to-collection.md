...
the sniffs that landed after that review — 94 warnings in 56 files, 33 in the
shipped sniffs and 61 in the test suite.

The reason is a single package-level fact rather than 94 separate judgements.
...
The 29 sites added since #312 are pinned on the package-level fact alone. They
