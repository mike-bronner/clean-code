...
the sniffs that landed after that review — 113 warnings in 61 files, 37 in the
shipped sniffs and 76 in the test suite.

The reason is a single package-level fact rather than 113 separate judgements.
...
The 48 sites added since #312 are pinned on the package-level fact alone. They
