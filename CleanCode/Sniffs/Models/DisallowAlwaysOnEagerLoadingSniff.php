 ...
 * - Only properties declared directly in the matched class body count. A local
 *   $with inside a method, and a property of a nested anonymous class, are
 *   both a different variable.
