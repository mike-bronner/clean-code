 ...
 *
 * All 101 are native calls kept on purpose. The reason is a single
 * package-level fact, recorded once in rules.xml and in
 * docs/standards/arrays-convert-to-collection.md rather than 101 times across
 ...
 * whole reason.
 *
 * The remaining 36 arrived with the sniffs that landed after #312 and are
