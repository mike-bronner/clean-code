...
try {
    doRiskyThing();
} catch (\Throwable $caughtUnqualified) {
...
try {
    doRiskyThing();
} catch (\Throwable | \RuntimeException $caughtMulti) {
    report($caughtMulti);
}
...
$handler = function (): void {
    try {
        doRiskyThing();
    } catch (\Throwable $caughtInClosure) {
