...
class DocblockOnlyComplexTypes
{
     ...
     */
    public function unionAnnotationOnly(int|string $value): void
    {
     ...
     */
    public function intersectionAnnotationOnly(\Countable&\ArrayAccess $subject): void
    {
     ...
     * @param mixed $value
     */
    public function mixedParameterAnnotationOnly(mixed $value): void
    {
     ...
     * @return mixed
     */
    public function mixedReturnAnnotationOnly(int $value): mixed
    {
        return $value;
    }
     ...
     * @return never
     */
    public function neverAnnotationOnly(): never
    {
...
class DocblockOnlyObjectTypes
{
     ...
     * @param object $value
     */
    public function objectParameterAnnotationOnly(object $value): void
    {
     ...
     * @return object
     */
    public function objectReturnAnnotationOnly(): object
    {
        return new \stdClass();
    }
}
...
class DocblockOnlyReturnComplexTypes
{
     ...
     * @return int|string
     */
    public function unionReturnAnnotationOnly(int $value): int|string
    {
     ...
     */
    public function intersectionReturnAnnotationOnly(\ArrayObject $value): \Countable&\ArrayAccess
    {
        return $value;
    }
     ...
     * @return static
     */
    public function staticReturnAnnotationOnly(): static
    {
        return $this;
    }
}
...
class DocblockOnlyNullableType
{
     ...
     */
    public function nullableParameterAnnotationOnly(?\DateTimeImmutable $value): void
    {
        echo $value?->format('c');
    }
}
