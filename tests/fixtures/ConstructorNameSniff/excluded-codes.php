...
/**
 * The one code CleanCode/ruleset.xml excludes: OldStyleCall, a PHP4-style *call* to a
 * parent constructor.
 *
 ...
 * tests/Ruleset/ConstructorNameTest.php: silent through CleanCode/ruleset.xml, and firing
