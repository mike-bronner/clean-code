 ...
 *
 * The four path-scoped custom sniffs are not in those datasets at all — their
 * scoping is decided from the file's real location, whether by PHP_CodeSniffer
 * reading rules.xml's patterns or by the sniff reading the path itself, so they
 ...
 * tests/Standards/DisallowChainedPropertyFetchTest.php and
