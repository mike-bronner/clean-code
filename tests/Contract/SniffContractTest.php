 ...
 *     DisallowCombinedConstructor, TooManyPublicMethods, ExcessiveMethodLength,
 *     ExcessiveParameterList, ExcessiveClassComplexity, ExcessivePublicCount,
 *     BooleanGetMethodName, ShortClassName, LineLength, ConstructorName,
 *     DiscourageGoto, Eval, NoSilencedErrors, VariableAnalysis,
 *     ShortMethodName) carry passing.php and failing.php but no autofixed.php,
 *     because there is no safe mechanical rewrite.
 *
